...
%______________________________________________________________________________________________________________________
\begin{document}
\name{\Large{Agnieszka Borowska} \hfill \small{24 September 2017} \hspace{2.8cm}} 
\begin{resume}
...
%__________________________________________________________________________________________________________________
   ...
   %__________________________________________________________________________________________________________________
    ...
    \textbf{University of Edinburgh},  The UK, \hfill Apr. 2017 -- Jun. 2017
	\vspace{1mm}\\
...
\section{\mysidestyle Ongoing \\Research } 
    ...
    with Siem Jan Koopman and Lennart F. Hoogerheide \vspace{1mm} \\   	
   	\textit{Efficient Bayesian Risk Evaluation},\\ 
    with Siem Jan Koopman and Lennart F. Hoogerheide \vspace{1mm} \\    
...
\section{\mysidestyle Conference \\and Seminar \\Presentations} 
    ...
    \textbf{Statistics Seminar Series of the School of Mathematics},\\ Edinburgh, The UK \hfill 19 May 2017 \vspace{1mm} \\ 
...
Modelling of the pension system reform with time inconsistency within the OLG framework; welfare analysis of various fiscal closures, constructing of the theoretical model and developing of its numerical solution -- intensive programming in Fortran; writing extensive  papers and carrying out literature reviews.\vspace{1.5mm} \\
...
Comparison and evaluation of the communication tools and institutional solutions implemented in selected central banks worldwide.  
   ...
   \section{\mysidestyle Additional\\ Courses \\and Trainings} 
	...
	\textbf{Reading Group on Bayesian Nonparametrics}\\
        University of Edinburgh, the UK \hfill May -- Jun. 2017\\
	...
	\textbf{Course on High Performance Computing}\\
        ...
        Introduction to Unix and cluster computing, basics of Hadoop and data analytics, GPU programming, HPC cloud.\vspace{1.5mm} \\
...
%
        ...
        Programming in Matlab,  VAR analysis of monetary policy, state space models and the Kalman Filter, applications (time-varying VARs and estimation of DSGE models).
...
%   __________________________________________________________________________________________________________________
 \newpage	
   ...
   Basics of Python, C, PHP, Visual Basic, SQL, BUGS/JAGS \vspace{1mm}\\
...
% Erasmus University Rotterdam, e-mail: \texttt{hkvandijk@ese.eur.nl }
%______________________________________________________________________________________________________________________
\end{resume}
\end{document}